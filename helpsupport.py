...
# This part is image labels setting start 
        ...
        std_b1 = Button(bg_img,command=self.whatsapp,image=self.std_img1,cursor="hand2")
        std_b1.place(x=250,y=200,width=180,height=180)

        std_b1_1 = Button(bg_img,command=self.whatsapp,text="Whatsapp",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
    ...
    def whatsapp(self):
        self.new = 1
        self.url = "https://api.whatsapp.com/send?phone=917380335579"
        webbrowser.open(self.url,new=self.new)
    
    def linkedin(self):
        self.new = 1
        self.url = "https://www.linkedin.com/in/aryan-trivedi-2b6330242/"
        webbrowser.open(self.url,new=self.new)
    
    def github(self):
        self.new = 1
        self.url = "https://github.com/222Aryan"
        webbrowser.open(self.url,new=self.new)
    
    def gmail(self):
        self.new = 1
        self.url = "https://mail.google.com/mail/u/0/#inbox?compose=CllgCJfsckCFGLVQsMvxzzgkQjzzFnsgMpSHhChbtKZfPVmVMDWtHGlXSLgnDJnpRrPjFfqvkVq"
        webbrowser.open(self.url,new=self.new)
